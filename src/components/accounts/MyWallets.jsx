            ...
            <div className="space-y-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <Card className="bg-red-50 dark:bg-red-900/20 border-red-100 dark:border-red-800">
                        ...
                        <div className="text-xl md:text-2xl font-bold text-red-700 dark:text-red-300">{formatMoney(totalDebt + totalLoanDebt)}</div>
                    </Card>
                </div>
                ...
                <Modal
                    isOpen={isAdding}
                    onClose={closeForm}
                    title={editingId ? 'Edit Wallet' : 'Add New Wallet'}
                >
                ...
                >
                    ...
                    <form onSubmit={handleAdjustmentSubmit} className="space-y-4">
                        ...
                        {(() => {
                            const diff = (parseFloat(newBalance) || 0) - (adjustingAccount?.balance || 0);
