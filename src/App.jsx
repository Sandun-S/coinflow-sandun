...
import { scheduleDailyReminder } from './utils/notifications'; // Import util

import LoginPage from './components/auth/LoginPage';
// ... existing imports ...

function App() {
  // Schedule notification on app load
  React.useEffect(() => {
  ...
  function Dashboard() {
    ...
    return (
      <MainLayout>
        ...
        <DailyCheckIn onAddTransaction={() => { setIsModalOpen(true); nextStep(); }} />
